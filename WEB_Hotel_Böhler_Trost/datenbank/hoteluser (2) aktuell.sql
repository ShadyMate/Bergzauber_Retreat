...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 12. Jan 2024 um 15:43
...
(1511, 'registriert', 'sdf', 'f', 'tomi2002@gmx.atdsd', 'asds', '$2y$10$b9et.JitVE14PasmHuqeRuQSLVArZnLxe8DqvlFBkkGASqrNor.Tm'),
(1512, 'registriert', 'fff', 'fffff', 'tomi2002@gmx.atffff', 'fff', '$2y$10$.9neugG.aUAoOqlHq3Ii8OYceFR4dTuNPubTlNo846sFFlv8QgRIm');
...
--
ALTER TABLE `user`
  MODIFY `userid` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1518;

--
-- AUTO_INCREMENT für Tabelle `zimmer`
--
ALTER TABLE `zimmer`
  MODIFY `zimmer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2562;
